<div style="text-align:center;">
  ...
  <h1 style="font-family: inherit; font-weight: bold; font-size: 1.5em;">Modeled Infant Pertussis Outcomes Across Vaccination, Exposure-Reduction, and Resistance-Management Scenarios: A Decision Analytical Modeling Study</h1>
  <br>
  <br>
...
- eTable 4. Intervention strategy definitions, modified control levers, and interpretive tier.
...
- eTable 24. Strategy tiers, decision role, and interpretation of model assumptions.
- eTable 25. Resistance-guided management assumption crosswalk.
...
We developed a deterministic age-structured compartmental model of *Bordetella pertussis* transmission to compare infant-protection mechanisms across implementability tiers while separating vaccine mechanism assumptions and macrolide-resistance dynamics. Outcomes included infant symptomatic cases, all-age infections, notified cases, resistant infections, and conditional epidemiologic scenario projections.
...
All incidence measures are reported as annualized counts per 100,000 persons unless stated otherwise. Infant outcomes combine the 0-2 month and 3-11 month age groups, because these strata jointly capture the highest-risk pre-primary-series and partially vaccinated infant population. Simulated scenario-ordering summaries are epidemiologic diagnostics; selected-parameter deterministic scenario-ordering diagnostics and exploratory burden translations are supplementary sensitivity analyses and do not constitute cost-effectiveness, feasibility, or equity-weighted policy appraisal.
...
| Scenario | Importation | Treatment differential | PEP differential | $f_R$ | Median end resistant fraction across illustrative profiles | IQR end resistant fraction | Median infant cases per 100k across illustrative profiles | Median resistant infections per 100k across illustrative profiles | Interpretation |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Australia | Nominal coverage floor without timeliness improvement | 23,985,714.89 | 398,454.72 | 186,703.58 | 22,474,991.43 | 0.00 | 0.00 |
...
| Brazil | Nominal coverage floor without timeliness improvement | 3,270,276.50 | 52,009.17 | 12,799.39 | 175,774.31 | -0.15 | -0.14 |
...
| China | Nominal coverage floor without timeliness improvement | 168,890,119.25 | 7,067,870.01 | 577,171.98 | 168,844,471.86 | -0.01 | -0.01 |
...
| Japan | Nominal coverage floor without timeliness improvement | 27,602,864.30 | 435,588.18 | 83,103.58 | 27,258,985.43 | 0.00 | 0.00 |
...
| New Zealand | Nominal coverage floor without timeliness improvement | 3,345,654.69 | 51,651.22 | 21,739.90 | 2,978,054.72 | -0.01 | -0.01 |
...
| South Africa | Nominal coverage floor without timeliness improvement | 1,313,792.31 | 19,283.91 | 6,802.93 | 215,178.87 | 0.49 | 0.44 |
...
| Sweden | Nominal coverage floor without timeliness improvement | 2,476,305.93 | 35,970.68 | 10,365.38 | 1,924,554.21 | -0.01 | -0.01 |
...
| Thailand | Nominal coverage floor without timeliness improvement | 685,943.78 | 9,996.39 | 2,196.99 | 18,360.60 | -0.09 | -0.10 |
...
| United Kingdom | Nominal coverage floor without timeliness improvement | 35,391,583.51 | 496,339.53 | 225,810.02 | 30,141,664.02 | -0.02 | -0.01 |
...
| United States | Nominal coverage floor without timeliness improvement | 7,848,636.15 | 125,131.05 | 30,779.84 | 0 | -0.06 | -0.06 |
...
| Scenario | Guided-treatment uptake | PEP restored | PEP reach multiplier | Median infant-case reduction across illustrative profiles vs current, 5 y | IQR reduction | Countries with positive reduction | Median infant cases per 100k across illustrative profiles | Implementation note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Sensitivity dimension | Strategy | Setting | Median infant cases per 100k across illustrative profiles, 5 y | IQR infant cases per 100k, 5 y | Median infant-case reduction across illustrative profiles vs current, 5 y | IQR reduction | Countries with positive reduction | Countries | Interpretation |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Temporal dimension | Scenario | Countries | Burn-in years | NPI reduction scale | Median infant cases per 100k across illustrative profiles, 5 y | IQR infant cases per 100k, 5 y | Median all infections per 100k across illustrative profiles, 5 y | Median end resistant fraction across illustrative profiles, 5 y | Implementation note |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Nominal coverage floor without timeliness improvement | 10 | 1,009.46 | 84.45 | 345.04 | None | Low-event countries are most sensitive to stochastic extinction or clustering assumptions. |
...
| Resistance-guided management | Dependent on testing reach, turnaround time, alternative treatment, PEP delivery, and adherence; modeled as a composite of symptomatic case recognition, alternative treatment effect, and contact PEP restoration. | Resistance-guided management modifier. | Can reduce absolute resistant infections under specified assumptions, but is not a stand-alone policy lever. |
...
**Panel A. Country resistance anchors and testing-recognition proxy.**

| Country profile | Baseline resistant fraction anchor | Evidence basis | Testing or recognition proxy used to interpret resistance-guided management |
| --- | --- | --- | --- |
| Australia | 4.3% (2024) | Measured national genomic-surveillance fraction | National targeted genomic surveillance; resistance-guided care interpreted as feasible where sequencing or equivalent resistance testing is available. |
| Brazil | 1.0% (2025) | Low-detected model anchor from reported resistant cases without a national denominator | Limited targeted recognition; resistance-guided care interpreted as triggered by local or imported-resistance concern. |
| China | 99.7% (2024) | Measured multicenter isolate fraction | High-resistance awareness; resistance-guided care interpreted as clinically actionable when resistance testing, local epidemiology, or empiric alternative therapy supports it. |
| Japan | 82.7% (2025) | Measured multicenter isolate fraction | Targeted laboratory recognition in an emerging high-resistance setting. |
| New Zealand | 1.0% (2025) | Low-detected model anchor | Limited targeted recognition; resistance-guided care interpreted as triggered by emerging or imported-resistance concern. |
| South Africa | 2.0% (2025) | Global-surveillance extrapolation anchor | Limited targeted recognition; testing availability and turnaround represented through implementation uptake. |
| Sweden | 1.0% (2025) | Low-imported model anchor | Targeted recognition for imported or epidemiologically linked resistant infections. |
| Thailand | 1.0% (2025) | Low-imported model anchor | Targeted recognition for imported or epidemiologically linked resistant infections. |
| United Kingdom | 0.3% (2024) | Measured national/reference-laboratory surveillance fraction | Reference-laboratory or selective testing pathway for suspected resistance. |
| United States | 0.0% (2015) | Historical multistate susceptibility-surveillance fraction | Low-resistance setting; testing interpreted as triggered by epidemiologic concern, treatment failure, or outbreak investigation. |

**Panel B. Shared strain-specific management assumptions and sensitivity ranges.**

| Component | Current-practice or standard macrolide assumption | Resistance-guided management composite | Sensitivity or interpretation |
| --- | --- | --- | --- |
| Diagnostic or recognition pathway | No explicit resistance-guided pathway; resistant infections receive standard macrolide-management assumptions. | Composite pathway representing rapid molecular resistance testing, culture/susceptibility testing, sequencing, or empiric alternative therapy when local resistance evidence supports it, followed by resistance-appropriate contact management. | Testing availability, turnaround time, clinician suspicion, drug choice, adherence, and public-health delivery are not separate model states; they are folded into implementation uptake and treatment/PEP parameters. |
| Symptomatic treatment transition | 0.025 per day. | 0.065 per day for the resistance-guided composite. | Uptake varied from 0.25 to 1.00 in implementation sensitivity analyses. |
| Treatment effect by strain | Sensitive infections: 20% shorter infectious duration and 15% lower infectiousness after treatment; resistant infections under standard macrolide practice: 10% shorter duration and 5% lower infectiousness. | Treated resistant infections: 45% shorter infectious duration and 35% lower infectiousness; sensitive-strain treatment assumptions unchanged. | Equalized-treatment counterfactuals in eTable 13 test whether strain-specific treatment differentials drive resistant-strain expansion. |
| PEP effectiveness by strain | Sensitive-strain PEP effectiveness 0.70; resistant-strain PEP effectiveness 0.10; baseline household-contact PEP coverage 0.30. | Resistant-strain PEP effectiveness restored to 0.45; baseline household-contact PEP coverage remains 0.30 unless the PEP-reach sensitivity changes it. | Implementation sensitivity varies resistant-strain PEP restoration yes/no and PEP reach multiplier 0.50-1.50. |
| Resistant-strain fitness | Main scenario assumes neutral relative fitness, $f_R$ = 1.00. | Same neutral fitness in the main resistance-guided comparison. | Fitness grids vary $f_R$ from 0.70 to 1.25, with narrative contrasts at 0.85, 1.00, and 1.15. |
| Implementation uptake | Not applicable as a separate modifier under current practice. | Main resistance-guided scenario applies the full composite uptake represented by the treatment and PEP parameter changes. | Uptake sensitivity spans 0.25, 0.50, 0.75, and 1.00; lower uptake represents incomplete testing access, delayed turnaround, limited alternative therapy, or incomplete adherence/delivery. |
