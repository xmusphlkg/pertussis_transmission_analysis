...
**Findings:** In this decision analytical model across 8 country profiles, an acellular pertussis-like vaccine reduced infant cases by 85.8% (IQR, 74.5% to 93.6%) vs no vaccination, while transmission-blocking and next-generation profiles produced larger reductions. Adolescent boosting, maternal immunization, resistance-guided treatment, next-generation vaccines, and combined strategies outperformed higher child coverage alone.
...
**Results:** Baseline annualized infant case incidence ranged from 16.0 in Singapore to 591.4 in New Zealand; all-infection incidence ranged from 36.6 in Singapore to 1,259 in Australia. Starting resistant fractions declined from a median of 1.0% to 0.0%. Compared with no vaccination, the symptom-protective profile reduced infant cases by 85.8%; transmission-blocking reduced infant cases by 99.9%; and next-generation vaccination reduced resistant infections by 100.0%. Increasing VE_inf from 0% to 90% across the resistance grid reduced infant cases by 99.7% (IQR, 99.4% to 99.7%). Median infant-case reductions were -5.0% for higher child coverage, 91.0% for adolescent boosting, 77.4% for maternal immunization, 81.3% for resistance-guided treatment, 99.6% for next-generation vaccination, and 99.6% for the combined strategy.
...
The calibrated country profiles produced wide variation in projected burden under current acellular pertussis-like vaccination and country-specific resistance anchors. Annualized infant case incidence ranged from 16.0 in Singapore to 591.4 in New Zealand, while all-infection incidence ranged from 36.6 in Singapore to 1,259 in Australia. Reported incidence ranged from 0.5 in Singapore to 21.6 in New Zealand, reflecting both transmission differences and age-specific observation assumptions. Resistant fractions started with a median of 1.0% (IQR, 0.8% to 23.9%) and declined to 0.0% (IQR, 0.0% to 0.3%) under the baseline assumption that resistant strains had lower relative fitness than sensitive strains.

### Vaccine Mechanism Scenarios

Compared with no vaccination, the symptom-protective acellular pertussis-like profile reduced infant cases by 85.8% (IQR, 74.5% to 93.6%) and total infections by 79.1% (IQR, 61.4% to 89.8%). Scenarios with stronger transmission blocking produced larger reductions in population transmission outcomes: the transmission-blocking profile reduced infant cases by 99.9% (IQR, 99.9% to 99.9%) and total infections by 99.9% (IQR, 99.9% to 99.9%). The next-generation profile reduced infant cases by 100.0% (IQR, 99.9% to 100.0%) and resistant infections by 100.0% (IQR, 99.8% to 100.0%), indicating that vaccine effects on infectiousness can influence both clinical and resistance-related outcomes.

### Macrolide Resistance and Transmission Blocking

Fixed resistance scenarios showed that resistant infection burden and resistant fraction were sensitive to initial resistance prevalence and importation. Median annualized infant case incidence under the low-resistance scenario was 109.5 (IQR, 51.2 to 333.1); resistant fractions were 5.2% (IQR, 4.3% to 6.4%) in the high-resistance scenario and 9.4% (IQR, 7.9% to 13.2%) in the very-high-resistance scenario. Across the VE_inf-resistance grid, increasing vaccine reduction in infectiousness from 0% to 90% reduced infant cases by 99.7% (IQR, 99.4% to 99.7%), supporting the importance of transmission-blocking effects when resistance threatens treatment and prophylaxis performance.

### Intervention Prioritization

Intervention rankings were heterogeneous across countries. Higher child coverage alone had a median infant-case effect of -5.0% (IQR, -8.7% to -2.3%), whereas adolescent boosting reduced infant cases by 91.0% (IQR, 70.7% to 94.6%), maternal immunization by 77.4% (IQR, 59.9% to 90.9%), resistance-guided treatment by 81.3% (IQR, 51.6% to 86.3%), next-generation vaccination by 99.6% (IQR, 99.4% to 99.8%), and the combined strategy by 99.6% (IQR, 99.3% to 99.9%). The largest absolute screening correlations with infant cases were fitness_R (r=0.61), relative_infectiousness_asymptomatic (r=0.59), treatment_rate_symptomatic (r=0.50).
