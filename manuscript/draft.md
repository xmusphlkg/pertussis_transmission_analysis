...
**Findings:** In this decision analytical model across 9 country profiles, an acellular pertussis-like vaccine reduced infant cases by 81.2% (IQR, 65.7% to 96.9%) vs no vaccination, while transmission-blocking and next-generation profiles produced larger reductions. Bayesian posterior predictive analysis estimated current-profile infant incidence at 367.2 (95% CrI, 8.3 to 4,830). Adolescent boosting, maternal immunization, resistance-guided treatment, next-generation vaccines, and combined strategies outperformed higher child coverage alone.
...
**Results:** Baseline annualized infant case incidence ranged from 8.3 in Thailand to 3,102 in China; all-infection incidence ranged from 17.6 in Thailand to 3,855 in China. Bayesian posterior predictive analysis estimated current-profile infant incidence at 367.2 (95% CrI, 8.3 to 4,830) and end-period resistant fraction at 0.1% (95% CrI, 0.0% to 100.0%). Starting resistant fractions declined from a median of 1.0% to 0.1% under the default lower-fitness assumption. Compared with no vaccination, the symptom-protective profile reduced infant cases by 81.2%; transmission-blocking reduced infant cases by 99.9%; and next-generation vaccination reduced resistant infections by 100.0%. Increasing VE_inf from 0.0% to 75.0% across the resistance grid reduced infant cases by 98.7%. Median infant-case reductions were -3.1% for higher child coverage, 76.5% for adolescent boosting, 69.5% for maternal immunization, 58.2% for resistance-guided treatment, 98.9% for next-generation vaccination, and 98.6% for the combined strategy.
...
The calibrated country profiles produced wide variation in projected burden under current acellular pertussis-like vaccination and country-specific resistance anchors. Annualized infant case incidence ranged from 8.3 in Thailand to 3,102 in China, while all-infection incidence ranged from 17.6 in Thailand to 3,855 in China. Reported incidence ranged from 0.3 in Thailand to 63.7 in China, reflecting both transmission differences and age-specific observation assumptions. Resistant fractions started with a median of 1.0% (IQR, 1.0% to 4.3%) and declined to 0.1% (IQR, 0.0% to 0.9%) under the baseline assumption that resistant strains had lower relative fitness than sensitive strains.

### Vaccine Mechanism Scenarios

Compared with no vaccination, the symptom-protective acellular pertussis-like profile reduced infant cases by 81.2% (IQR, 65.7% to 96.9%) and total infections by 70.3% (IQR, 49.1% to 95.4%). Scenarios with stronger transmission blocking produced larger reductions in population transmission outcomes: the transmission-blocking profile reduced infant cases by 99.9% (IQR, 99.8% to 99.9%) and total infections by 99.9% (IQR, 99.7% to 99.9%). The next-generation profile reduced infant cases by 99.9% (IQR, 99.9% to 100.0%) and resistant infections by 100.0% (IQR, 99.7% to 100.0%), indicating that vaccine effects on infectiousness can influence both clinical and resistance-related outcomes.
...
Intervention rankings were heterogeneous across countries. Higher child coverage alone had a median infant-case effect of -3.1% (IQR, -6.7% to -1.6%), whereas adolescent boosting reduced infant cases by 76.5% (IQR, 50.2% to 90.1%), maternal immunization by 69.5% (IQR, 39.4% to 83.4%), resistance-guided treatment by 58.2% (IQR, 37.2% to 79.5%), next-generation vaccination by 98.9% (IQR, 94.8% to 99.7%), and the combined strategy by 98.6% (IQR, 95.3% to 99.8%). The largest absolute screening correlations with infant cases were waning_rate_natural (r=0.54), infectious_duration_asymptomatic (r=0.52), fitness_R (r=0.51).
