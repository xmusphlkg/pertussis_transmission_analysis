...
**Findings:** In this decision analytical model of 10 illustrative country profiles, marginal childhood coverage floors and adolescent boosting produced small or inconsistent infant-case reductions, pregnancy Tdap produced modest direct benefit, and infant-exposure reduction, resistance-guided management, and high-transmission-blocking vaccine profiles produced larger reductions.

**Meaning:** Prioritization should separate routine vaccination, pregnancy Tdap, exposure-reduction adjuncts, resistance management, and hypothetical vaccine product targets rather than rank them as directly substitutable policies.
...
**Results:** Across calibrated profiles, current-practice annual infant case incidence ranged from approximately 16 to 2393 per 100,000 infants; infant incidence was not directly calibrated. Calibration-window mean absolute percentage error for reported cases was 5.5% (interquartile range [IQR], 3.9%-7.8%). Routine childhood coverage floors did not produce a consistent infant-case reduction (median, -1%; IQR, -5% to -1%), and adolescent boosting had a small and uncertain reduction (median, 2%; IQR, 0%-58%). Pregnancy Tdap scale-up produced a median 12% reduction (IQR, 10%-14%); the infant-exposure reduction composite produced a median 45% reduction (IQR, 25%-77%). Targeted high-risk PEP produced a 5% median reduction. Resistance-guided management produced median reductions of 41% for infant cases and 97% for resistant infections. High-transmission-blocking and combined stress-test profiles produced median reductions of 97% or higher.
...
Strategy profiles showed a separation by decision role (<span style="color:#5DADE2;">Figure 4A-4C</span>). Routine childhood coverage floors did not produce a consistent infant-case reduction (median, -1%; IQR, -5% to -1%), and adolescent booster scale-up produced a small and uncertain reduction (median, 2%; IQR, 0%-58%).

Pregnancy Tdap scale-up produced a median 12% infant-case reduction (IQR, 10%-14%). The close-contact/cocooning adjunct produced a median 37% reduction, and the infant-exposure reduction composite produced a median 45% reduction (IQR, 25%-77%). Component diagnostics produced median reductions of 12% for pregnancy Tdap alone, 35% for reproductive-age adult boosting, and 3% for cocooning/contact reduction alone. Targeted high-risk PEP produced a median 5% reduction. Resistance-guided management produced median reductions of 41% for infant cases and 97% for resistant infections under fixed implementation assumptions. The high-transmission-blocking vaccine target and combined stress-test profiles produced median reductions of 97% or higher.

Country-level heterogeneity was greater for strategies acting through older-age transmission. The childhood coverage floor improved infant outcomes in 1 of 10 profiles and increased infections in most age groups in the age-shift diagnostic. Adolescent boosting produced positive infant-case reductions in 5 of 10 profiles. Pregnancy Tdap scale-up, cocooning adjuncts, infant-exposure reduction, resistance-guided management, high-transmission-blocking vaccine targets, and combined stress-test profiles reduced infant cases in all 10 profiles. For secondary outcomes, infant-exposure reduction reduced median reported cases by 38% and all infections by 35%; pregnancy Tdap reduced median infant deaths by 61% and all infections by 1%.
...
In rank-stability diagnostics, the combined stress-test profile ranked first in 8 of 10 full-horizon country profiles and in 36 of 50 country-window cells, while the high-transmission-blocking vaccine target was usually within the 2 lowest-burden profiles. Infant-exposure reduction, cocooning adjuncts, pregnancy Tdap scale-up, targeted high-risk PEP, adolescent boosting, and resistance-guided management changed rank across countries, infant age strata, and time windows.
...
Macrolide resistance changed management-related outcomes but did not overturn the main vaccination-prioritization pattern. Resistance-guided management had simulated benefit under fixed assumptions and was strongly associated with lower resistant infections, but its value depended on testing reach, timely detection, alternative-drug availability, PEP implementation, and resistant-strain fitness. Recent reports of MRBP expansion in China, Japan, Australia, the Americas, and genomic surveillance studies support treating resistance as a modifier of strategy value and uncertainty, not as an independent claim that a specific vaccination program should be ranked first.^14-21,30^
